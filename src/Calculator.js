    ...
    <div className='main'>
        {/* heading */}
          ...
          <div className='buttons_containers'>
              ...
              <button onClick={clickHandler} className='clear'>C</button>
              <button onClick={clickHandler} className='di'>/</button>
              <button onClick={clickHandler} className='mul'>*</button>
              <button onClick={clickHandler} className='min' >-</button>
              <button onClick={clickHandler}>7</button>
              <button onClick={clickHandler}>8</button>
              <button onClick={clickHandler}>9</button>
              <button onClick={clickHandler} className='plus'>+</button>
              <button onClick={clickHandler} >4</button>
              <button onClick={clickHandler}>5</button>
              <button onClick={clickHandler}>6</button>
              <button onClick={clickHandler} className='equal'>=</button>
              <button onClick={clickHandler }>1</button>
              <button onClick={clickHandler}>2</button>
              <button onClick={clickHandler} >3</button>
              <button onClick={clickHandler}>0</button>
              <button onClick={clickHandler} className='dot'>.</button>
